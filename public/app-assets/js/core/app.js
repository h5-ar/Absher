...
window.colors = {
    solid: {
        primary: ' var(--nav-item-sub-selected-background) ',
        secondary: '#82868b',
        success: '#28C76F',
        info: '#00cfe8',
        warning: '#FF9F43',
    ...
    light: {
        primary: ' var(--nav-item-sub-selected-background) 1a',
        secondary: '#82868b1a',
        success: '#28C76F1a',
        info: '#00cfe81a',
        warning: '#FF9F431a',
...
(function (window, document, $) {
    ...
    function setLayout(currentLocalStorageLayout) {
        ...
        setThemeToSession(currentLocalStorageLayout)
