        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <li class="scrollable-container media-list">
                        <div id="normal-notifications">
                            ...
                            <a class="d-flex notification-item"
                                data-href="{{ route('SAnotifications.show', $notification->id) }}"
            ...
            <li class="nav-item d-none d-lg-block" title="{{ translate('Theme', 'descriptions') }}">
                ...
                <a class="nav-link " href="{{ route('logout') }}">
                    <i class="ficon" data-feather="power">
                    </i>
                </a>
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="user-nav d-sm-flex d-none">
                        ...
                        <span class="user-status"></span>
                            ...
                            src="https://ui-avatars.com/api/?name={{auth()->user()->username}}" alt="avatar" height="40"
...
<script>
    function markAllAsRead() {
        $.ajax({
            type: "PUT",
            url: "{{ route('SAnotifications.readAll') }}",
            data: {
                _token: "{{ csrf_token() }}"
            },
    ...
    function markAsRead(elem) {
        ...
        $.ajax({
                type: "PUT",
                url: "{{ route('SAnotifications.read', '') }}/" + notificationId,
                data: {
                    _token: "{{ csrf_token() }}"
                },
