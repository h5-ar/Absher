...
<head>
    ...
    @include('DashboardSuperAdmin.Layouts.parts.headStyle')
    @stack('styles')
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
    ...
    <!-- BEGIN: Header-->
    @include('DashboardSuperAdmin.Layouts.parts.header')
    <!-- END: Header-->


    <!-- BEGIN: Main Menu-->
    @include('DashboardSuperAdmin.Layouts.parts.side')
    <!-- END: Main Menu-->
                ...
                Notification.requestPermission().then(function(permission) {
                    if (permission === 'granted') {
                        getToken(messaging, {
                            ...
                            vapidKey: 'BClQZ5zAvTfR3YazGM4JP4AMj1NW_4_hZIYsSrb7L0QCtwJA4UeZatBNY_sYmxG-yXlWCVYybDzAYNmbisxgMmU'
                        }).then((currentToken) => {
                            if (currentToken) {
                                $.ajax({
                                    type: "POST",
...
//                var unreadNotificaitonCount = Number($('#unread-notifications-count').text());
  //              $('#unread-notifications-count').text(++unreadNotificaitonCount)
        ...
        @include('DashboardSuperAdmin.Layouts.parts.bodyScripts')
