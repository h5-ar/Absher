...
@section('title', translate('Notification Details'))
        ...
        <div class="card-header card-header-teal">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="mb-0 font-weight-bold" style="font-size: 1.5rem;">
                    <i class="fas fa-bell mr-2"></i> {{ translate('Notification Details') }}
                </h3>
        ...
        <div class="card-body card-body-teal">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="content-card h-100">
                        <div class="content-card-header d-flex align-items-center">
                            ...
                            <h4 class="mb-0">{{ translate('Company Details') }}</h4>
                        </div>
                        <div class="content-card-body">
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Company Name') }}</div>
                                    <div class="info-value">
                                        {{ $notification->data['company']['name'] }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Company Phone') }}</div>
                                    <div class="info-value">
                                        {{ $notification->data['company']['phone'] }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Company Email') }}</div>
                                    <div class="info-value">
                                        {{ $notification->data['company']['email']  }}
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 mb-4">
                    <div class="content-card h-100">
                        <div class="content-card-header d-flex align-items-center">
                            ...
                            <h4 class="mb-0">{{ translate('User Details') }}</h4>
                        </div>
                        <div class="content-card-body">
                            <!-- الاسم الكامل -->
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Fill Name') }}</div>
                                    <div class="info-value">
                            ...
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('User Email') }}</div>
                                    <div class="info-value">
                            ...
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('User Name') }}</div>
                                    <div class="info-value">
                            ...
                            <div class="company-info-item">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Phone User') }}</div>
                                    <div class="info-value">
            ...
            <div class="content-card">
                <div class="content-card-header d-flex align-items-center">
                    ...
                    <h4 class="mb-0">{{ translate('Notification Details') }}</h4>
                </div>
                <div class="content-card-body">
                    <div class="row">
                        <!-- سبب الإشعار -->
                        <div class="col-md-6 mb-4 mb-md-0">
                            <div class="company-info-item" style="border-bottom: none; padding: 0;">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Reason') }}</div>
                        ...
                        <div class="col-md-6">
                            <div class="company-info-item" style="border-bottom: none; padding: 0;">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Sent At') }}</div>
                                    <div class="info-value" style="font-size: 1.1rem;">
                        ...
                        <div class="col-md-6">
                            <div class="company-info-item" style="border-bottom: none; padding: 0;">
                                ...
                                <div class="info-content">
                                    <div class="info-label">{{ translate('Read At') }}</div>
                                    <div class="info-value" style="font-size: 1.1rem;">
            ...
            <div class="d-flex justify-content-between align-items-center mt-5 pt-4 border-top">
                <a href="{{ route('super_admin.dashboard') }}" class="btn btn-outline-teal" style="padding: 0.75rem 2rem;">
                    <i class="fas fa-arrow-right ml-2"></i> {{ translate('Back') }}
                </a>
            </div>
        </div>
    </div>
