...
<x-Content.normal>
    <div class="card shadow">
        ...
        <div class="card-header">
            <x-Button.add name="Add Reservation" route="{{ route('SAadd.reservation') }}" />
        </div>

        <div class="card-body ">
            <div id="page-data">
                @include('DashboardSuperAdmin.SuperAdmin.Reservation.Section.indexTable',['reservations' => $reservations])
            </div>
        </div>
    </div>
</x-Content.normal>
